...
export class SeedDb1667314843327 implements MigrationInterface {
  name = 'SeedDb1667314843327';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    //password 123
    await queryRunner.query(
      `INSERT INTO users (username, email, password) VALUES ('foo', 'foo@gmail.com', '$2b$10$U819RKEh8rOhMZouEZAIm.OmJG7A0ylshTiFB7/fgSyJIoDhMjhV6')`,
    );
    await queryRunner.query(
